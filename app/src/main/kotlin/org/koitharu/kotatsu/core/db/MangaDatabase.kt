...
import org.koitharu.kotatsu.core.db.dao.ChapterReadDao
...
@Database(
	entities = [
		...
		MangaSourceEntity::class, StatsEntity::class, LocalMangaIndexEntity::class, ChapterReadEntity::class,
	],
...
abstract class MangaDatabase : RoomDatabase() {
	...
	abstract fun getChapterReadDao(): ChapterReadDao
}
